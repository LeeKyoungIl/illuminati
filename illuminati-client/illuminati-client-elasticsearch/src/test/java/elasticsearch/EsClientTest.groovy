...
import com.leekyoungil.illuminati.elasticsearch.infra.param.mapping.EsIndexMapping
...
class EsClientTest extends Specification {
    ...
    def "get mapping struct from model" () {
        ...
        String mappingJsonString = sampleEsTemplateInterfaceModel.getIndexMapping();


        when:
        EsClient esClient = new ESclientImpl(new IlluminatiHttpClient(), this.elasticSearchHost, this.elasticSearchPort);
//        Map<String, Object> illuminatiEsModelMap = ConvertUtil.ConvertObjectToMap(sampleEsTemplateInterfaceModel);
