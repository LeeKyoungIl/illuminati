package me.phoboslabs.illuminati.data.consumer.listener;

import lombok.RequiredArgsConstructor;
import me.phoboslabs.illuminati.common.constant.IlluminatiConstant;
import me.phoboslabs.illuminati.common.util.StringObjectUtils;
import me.phoboslabs.illuminati.data.consumer.store.elasticsearch.model.EsTemplateInterfaceModel;
...
public class SubscribeListener {
    ...
    public void subscribe (Message<?> message) {
        // es part
        EsTemplateInterfaceModel sampleBuyEsModel = null;

        try {
            String jsonString = (String) message.getPayload();
            sampleBuyEsModel = IlluminatiConstant.ILLUMINATI_GSON_OBJ.fromJson(jsonString, EsTemplateInterfaceModel.class);
        } catch (Exception ex) {
