package me.phoboslabs.illuminati.data.consumer.store.elasticsearch.model;
...
public class EsTemplateInterfaceModel extends IlluminatiEsTemplateInterfaceModelImpl {

    private final static Logger SAMPLE_ES_CONSUMER_LOGGER = LoggerFactory.getLogger(EsTemplateInterfaceModel.class);
    
    public EsTemplateInterfaceModel() {
        super();
    }
