...
## I recommend the RabbitMQ for the current version.(0.9.9.8)
...
## 현 버전 (0.9.9.8) 에서는 rabbitmq를 권장 합니다.
 ...
 * pom.xml 혹은 build.gradle에서 illuminati-processor 부분만 주석처리를 하면 됩니다.
