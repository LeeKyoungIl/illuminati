...
//
////        IlluminatiEsTemplateInterfaceModelImpl illuminatiEsModelImpl = new IlluminatiEsTemplateInterfaceModelImpl(general, header, elapsedTime, output, id, 1502120199214L);
////
