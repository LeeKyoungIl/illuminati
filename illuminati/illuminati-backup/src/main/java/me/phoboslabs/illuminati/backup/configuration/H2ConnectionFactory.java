...
package me.phoboslabs.illuminati.backup.configuration;
...
public class H2ConnectionFactory {
    ...
    private static final String DB_CONNECTION = "jdbc:h2:file:./illuminati-infra.backup;FILE_LOCK=NO;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE";
